 <h1 style="text-align: center;">Novo Pedido de Venda</h1>
            ...
            <div style="overflow-x: auto;">
                <table class="products-table">
                    ...
                    <tbody id="products-list">
                        ...
                        <tr id="empty-message">
                            <td colspan="6" style="text-align: center; color: var(--secondary-text-color);">Nenhum produto adicionado ainda.</td>
                        </tr>
                    </tbody>
                </table>
            </div>
